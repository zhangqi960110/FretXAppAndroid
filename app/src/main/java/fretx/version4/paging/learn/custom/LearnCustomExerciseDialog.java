...
public class LearnCustomExerciseDialog extends DialogFragment
{
    ...
    public interface LearnCustomExerciseDialogListener {
        void onUpdate(boolean replay);
    }

    public static LearnCustomExerciseDialog newInstance(LearnCustomExerciseDialogListener listener, int min, int sec) {
        LearnCustomExerciseDialog dialog = new LearnCustomExerciseDialog();
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        ((LearnCustomExerciseDialogListener) parentFragment).onUpdate(replay);
    }
}